  ...
  ?>
   ...
   <form method="POST" action="<?php echo es($_SERVER['PHP_SELF']); ?>">
     <ul>
       ...
       <li><span>結婚:</span>
           <label><input type="radio" name="marriage" value="独身" <?php checked("男性", $marriage); ?> >独身</label>
           <label><input type="radio" name="marriage" value="既婚" <?php checked("男性", $marriage); ?> >既婚</label>
